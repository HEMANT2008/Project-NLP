...
set_background(r"D:\HOTEL REVIEW KARAN\white.png")
...
side_bg = r"D:\HOTEL REVIEW KARAN\img_1.png"
sidebar_bg(side_bg)
...
pickle_in=open(r"D:\HOTEL REVIEW KARAN\ml_model (3).pkl",'rb')
tfidf_in=open(r"D:\HOTEL REVIEW KARAN\tfidf (2).pkl",'rb')
log=pickle.load(pickle_in)
tfidf=pickle.load(tfidf_in)

df=pd.read_excel(r"D:\HOTEL REVIEW KARAN\hotel_reviews.xlsx")
